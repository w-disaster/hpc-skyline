...
*/		
	...
	*/
	...
	cudaOccupancyMaxPotentialBlockSize(&minGridSize, &blockSize, skyline, 0, 0); 
  	// Round up according to array size 
  	gridSize = (*N + blockSize - 1) / blockSize; 
	dim3 grid(1, gridSize);
	...
	cudaEventRecord(t_kernel_stop);
  	...
  	int maxActiveBlocks;
  	cudaOccupancyMaxActiveBlocksPerMultiprocessor(&maxActiveBlocks, skyline, blockSize, 0);
